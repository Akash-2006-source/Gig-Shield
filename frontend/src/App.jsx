...
import ClaimLabelingDashboard from './pages/admin/ClaimLabelingDashboard'
    ...
    <ErrorBoundary>
      <Router>
        <Routes>
          ...
          <Route path="/admin/claim-labeling" element={<AdminRoute><ClaimLabelingDashboard /></AdminRoute>} />
